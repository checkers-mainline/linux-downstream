...
#define GT91XX_NOISE_PROC_FILE      "touch_noise"
...
#define GTP_REG_NOISE                   0xC6EC
#define GTP_REG_WORK_FREQ               0xCE0E
#define GTP_REG_BASE_FREQ               0x8067
#define GTP_REG_START_FREQ              0x807A
#define GTP_REG_END_FREQ                0x807B
